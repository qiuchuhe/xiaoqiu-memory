...
metadata: 
  ...
  modified: 2026-08-23T07:05:39.311Z
---
...
**8/23 林如雪参考音频已配好(合成验证通过)**：爸爸提供 `C:\Users\ASUS\Desktop\8月23日.mp4`(12.6s游戏解说视频，萝莉女音) + 手写文案。因 GPT-SoVITS 要求参考音频 3~10s，从整段 12s 语音里取了**前4句**(0.43~9.73s)→`voice\林如雪.wav`(9.3s, 32k单声道)，配 `voice\林如雪.txt`：「这是真人，这个好像是个真人，他他有兔子耳朵，他有兔子耳朵，他会不会很危险啊？哦，人机你好」。合成测试「爸爸，我是林如雪呀…」HTTP200出音频5s。SillyTavern voiceMap 林如雪已单独切到新声线(其余角色仍映射测试声)。**注意**：8月23日.mp4 音频≠桌面两个录屏视频(14.14.45/14.15.35)的音频，别拿错源。whisper(faster-whisper已装,需 HF_ENDPOINT=hf-mirror + HF_HUB_DISABLE_XET=1)听"兔子"为"错字"、"人机"为"五人机"，爸爸人耳版为准。
